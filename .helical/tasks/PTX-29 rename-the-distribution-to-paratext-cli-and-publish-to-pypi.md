...
horizon: now
flow: clear
result: Distribution renamed to paratext-cli; `import paratext` and the `paratext` command are unchanged. Published the same day via PyPI trusted publishing, with release docs and a publish workflow.
created: '2026-08-12'
updated: '2026-08-12'
---
