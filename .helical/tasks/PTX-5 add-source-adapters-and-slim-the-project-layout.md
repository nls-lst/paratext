...
horizon: now
flow: clear
result: image_source and pdf_source adapters added, default view derived from the schema, and project.py collapsed into __init__.py. A project is now a folder holding __init__.py, schema.py and prompt.md.
created: '2026-06-28'
updated: '2026-06-28'
---
